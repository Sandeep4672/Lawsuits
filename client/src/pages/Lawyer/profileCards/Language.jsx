...
export default function LanguagesCard({ languages, editMode, onChange }) {
  return (
    <div className="bg-white/10 backdrop-blur-md hover:scale-[1.02] p-6 rounded-xl transition-all duration-400 border border-blue-500 shadow-xl hover:shadow-blue-300">
