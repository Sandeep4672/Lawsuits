...
export default function ProfilePage() {
  ...
  const handlePasswordChange=async(e)=>{
    ...
    {
        //const errorMsg = err.res.statusCode || "Failed to update password.";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-100 to-white py-20 px-4 ">
      <div className="max-w-2xl mx-auto bg-white rounded-2xl shadow-xl p-8 ">
        ...
        <div className="mt-8">
          <h3 className="text-xl font-semibold mb-2 text-green-700">🔒 Change Password</h3>
          <form className="space-y-4" onSubmit={handlePasswordChange}>
            ...
            {message && (
            <p className={`mt-4 text-center text-sm  ${success?"text-green-600": "text-red-600"}`}>{message}</p>
          )}
        </div>
      </div>
    </div>
